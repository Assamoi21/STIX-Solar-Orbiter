...
hdulist1 = fits.open("C:/Users/Assamoua Koman/Nextcloud/stage_2025/STIX_2025/data/stx_spectrum_2107170019.fits" )
...
hdulist = fits.open("C:/Users/Assamoua Koman/Nextcloud/stage_2025/STIX_2025/data/stx_srm_2107170019.fits" )
hdulist.info()
...
def integral(e1, e2):
    return (e2 - e1) / 6.0 * (differential_flux(e1) + 4 * differential_flux((e1 + e2) / 2.0)+ differential_flux(e2)) # Ceci n'est
# t'il pas divisé par 3 au lieu de 6 d'après l'intégrale de Simpson.

# true photon fluxes integrated over the photon bins of the response
true_fluxes = integral(Energy_low[:], Energy_hi[:])
print('Energy_low:',Energy_low)
print(' Energy_hi:', Energy_hi)
print('true_fluxes:',true_fluxes.shape)
# dNp/(dt dA)
...
print('folded_counts:',folded_counts.shape)
...
## Flux : voir de 10-100 keV qui correspond bien et entre 4-10keV qui correspond pas trop.
